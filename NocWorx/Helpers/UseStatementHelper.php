...
class UseStatementHelper
{
	...
	/** @var \NocWorx\Helpers\UseStatement[][] Cached data for method getUseStatements() */
	 ...
	 * @return \NocWorx\Helpers\UseStatement[] canonicalName(string) => useStatement(\NocWorx\Helpers\UseStatement)
	 */
