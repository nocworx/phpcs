...
class ReferencedNameHelper
{
	...
	/** @var \NocWorx\Helpers\ReferencedName[][] Cached data for method getAllReferencedNames, cacheKey(string) => pointer(integer) => name(string) */
	private static $allReferencedTypesCache = [];

	/**
	 * @param \PHP_CodeSniffer\Files\File $phpcsFile
	 * @param int $openTagPointer
	 * @return \NocWorx\Helpers\ReferencedName[] referenced names
	 */
